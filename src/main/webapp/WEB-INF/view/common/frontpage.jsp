                ...
                <div class="flex-shrink-0">
                    <div>
                        <a href="/schedules" class="">
                            <img src="https://cdn-icons-png.flaticon.com/512/1968/1968779.png " width="25" height="25" alt="" title="" class="img-small">
                        </a>
                    </div>
                </div>
            </div><!-- end card header -->
        ...
        <div class="card card-height-75">
            <div class="card-header align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <div>
                        <a href="/tasks" class="">
                            <img src="https://cdn-icons-png.flaticon.com/512/2387/2387635.png " width="30" height="30" alt="" title="" class="img-small">
                        </a>
                    </div>
                </div>
            </div><!-- end card header -->
            ...
            <div class="card-body p-0">
                ...
                <div class="align-items-center p-3 justify-content-between d-flex">
                    <div class="flex-shrink-0">
                        <div class="text-muted ps-2"><span class="fw-semibold">Task</span>
                        </div>
                    </div>
                    <div class="flex-shrink-0">
                        <div class="text-muted float-end pe-3"><span class="fw-semibold">Start date</span>
                        </div>
                    </div>
                </div><!-- end card header -->
                            ...
                            <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                                <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                    ...
                                    <div class="simplebar-content" style="padding: 0px;">
                                        <ul class="list-group list-group-flush border-dashed px-3" id="taskList">
                                        </ul><!-- end ul -->
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card-header align-items-center d-flex">
                ...
                <div>
                    <a href="/notifications" class="">
                        <img src="https://cdn-icons-png.flaticon.com/512/4764/4764539.png " width="28" height="28" alt="" title="" class="img-small">                    </a>
                </div>
            </div><!-- end card-header -->

            <div class="card-body pt-0" id="notificationList" style="height: 300px">
            </div><!-- end card body -->
            <div class="mb-3 text-center"><a href="/notifications" class="text-muted text-decoration-underline">View all News</a></div>
        </div><!-- end card -->
    </div>
    <div class="col-xxl-4">
    </video>
            ...
            if (rs) {
                ...
                data.responseList.forEach(function (task, index) {
                    xhtml += '<li class="list-group-item ps-0">' +
                        ...
                        '<label class="form-check-label mb-0 ps-2" for="task_one"><a href="/tasks/' + task.id + '" >' + task.title + '</a></label>' +
                        '</div>' +
                        '<div class="flex-shrink-0 ms-2">' +
                        '<p class="text-muted fs-12 mb-0">' + task.startDate + '</p>' +
                        '</div>' +
                        '</div>' +
                        '</li>';
                })
                $(".counter-opened-task").attr("data-target", getTaskCountByCode(data.statusTaskCounts, T_OPENED));
                $(".counter-reopened-task").attr("data-target", getTaskCountByCode(data.statusTaskCounts, T_REOPENED))
