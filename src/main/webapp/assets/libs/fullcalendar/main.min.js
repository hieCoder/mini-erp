...
var FullCalendar = function (e) {
    ...
    var Eu = zo({themeClasses: {bootstrap: yu}}), Su = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
    ...
    },e.triggerDateSelect = mr,e.unmountComponentAtNode = No,e.unpromisify = yo,e.version = "5.11.2",e.whenTransitionDone = Ne,e.wholeDivideDurations = Wt,Object.defineProperty(e, "__esModule", {value: !0}),e
}({});