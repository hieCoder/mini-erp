...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var g = new bootstrap.Modal(document.getElementById("event-modal"), {keyboard: !1}),
        ...
        y = [{id: 1, title: "World Braille Day", start: "2022-01-04", className: "bg-soft-info", allDay: !0}, {
            id: 2,
            ...
            className: "bg-soft-info",
            allDay: !0
        }, {id: 5, title: "World Thinking Day", start: "2022-02-22", className: "bg-soft-info", allDay: !0}, {
            id: 6,
            title: "International Mother Language Day",
            start: "2022-03-21",
            className: "bg-soft-info",
            allDay: !0
        }, {id: 7, title: "World Water Day", start: "2022-03-22", className: "bg-soft-info", allDay: !0}, {
            id: 8,
            ...
            className: "bg-soft-info",
            allDay: !0
        }, {id: 10, title: "Earth Day", start: "2022-04-22", className: "bg-soft-info", allDay: !0}, {
            id: 153,
            title: "All Day Event",
    ...
    callAjaxByJsonWithData("/api/v1/schedules/" + userId +"?monthly="+currentApiDate,"GET",null,function (rs) {
                if(rs){
                    ...
                    i.addEventListener("submit", function (e) {
                        e.preventDefault();
                        var t, n, e = document.getElementById("event-title").value, a = document.getElementById("event-category").value,
                            d = document.getElementById("event-start-date").value.split("to"), i = new Date(d[0].trim()),
