...
public class AccountingController {
    ...
    public ModelAndView showAllMonthlyHistory() {
        ...
        SettingAllowanceResponse settings = new SettingAllowanceResponse(ApplicationConstant.MAX_FILE_SIZE,setting.getFileType(),setting.getImageType(),setting.getFileSize());
